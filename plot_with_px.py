...
fig= px.scatter(plotting_df, x="gdp_per_capita", y="life_expectancy",
                animation_frame="dt_year",animation_group="countury_name",
                size="population",color="continent",hover_name="countury_name",
                size_max=100, range_x=[500,100000],range_y=[20,90],
                log_x= True, title="Gapminder_Clone 1800-2023")
